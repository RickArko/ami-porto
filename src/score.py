...
dfbase = pd.read_csv("data/baseline_predictions.csv").rename(columns={
    "pred": "pred_baseline",
    "pred_label": "label_baseline"
})
...
if __name__ == '__main__':
    ...
    plt.plot(fpr, tpr, label=f"Model {roc_model:.3f}", color="Green", alpha=.95)
